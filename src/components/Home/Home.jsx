  ...
  return (
    <div className="box">
      ...
      <Container
        ...
        <Typography className="txt" variant="h4">
      ...
      <Container
          ...
          <Box
            ...
            <CardContent sx={{ flex: "1 0 auto" }}>
              <Typography component="div" variant="h5">
                Want to know more about art and its styles?
              </Typography>
              <Typography
                variant="subtitle1"
        ...
        <Card
          ...
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            <CardContent sx={{ flex: "1 0 auto" }}>
              <Typography component="div" variant="h5">
                Course about ancient history and specific signs
              </Typography>
              <Typography
                variant="subtitle1"
                color="text.secondary"
      ...
      <Container
        ...
        <Card
          ...
          <Box
            ...
            <CardContent sx={{ flex: "1 0 auto" }}>
              <Typography component="div" variant="h5">
                True cinema lovers need this knowledge for sure!
              </Typography>
              <Typography
                variant="subtitle1"
                color="text.secondary"
